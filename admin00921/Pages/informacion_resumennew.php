...
<fieldset>
                            ...
                            <H2 class="texto-titu2">Estado actual de la postulaci&oacute;n  <a href='#' id="estadopostulacion" class='inline-link-g0'><?php echo $estadopostulacion; ?></a>, cambiar a <span >
					...
					?>
                    		...
                    		<H2 style="width:650px;">PONDERACION ACTUAL <span id="irn_ponderacion" class="texto-titu2" style="color:#C66653; font-size:18px;"><?php echo $nota; ?></span>  Modificada el <span class="texto-titu2" style="color:#C66653; font-size:15px;"><?php echo $fecha; ?> </span></H2>
