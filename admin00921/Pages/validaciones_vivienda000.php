...
$query = "select * from  listar_evaluadores_vivienda where IDPONDVIVIENDA = ".$_GET["l"]." and IDESTADOBECA IN (2,3,4,7)";
                    ...
                    <tbody>
                          ...
                          <tbody id="validaciones_vivienda">
                            ...
                            <tr>     	
                                ...
                                <td><input type="text" name="tr19" value="<?php echo $row->tr19; ?>" ></td>
                            </tr>
                            <tr>     	
