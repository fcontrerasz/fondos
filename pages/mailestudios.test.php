...
$message = str_replace('[archivocontrato]', (($g[0]->ARCHIVO_CONTRATO === NULL))?'--SIN ARCHIVO--':'ADJUNTADO', $message);
$message = str_replace('[archivoliq1]', (($g[0]->ARCHIVO_LIQ1 === NULL) || ($g[0]->ARCHIVO_LIQ1 == ""))?'--SIN ARCHIVO--':'ADJUNTADO', $message);
$message = str_replace('[archivoliq2]', (($g[0]->ARCHIVO_LIQ2 === NULL) || ($g[0]->ARCHIVO_LIQ2 == ""))?'--SIN ARCHIVO--':'ADJUNTADO', $message);
$message = str_replace('[archivoliq3]', (($g[0]->ARCHIVO_LIQ3 === NULL) || ($g[0]->ARCHIVO_LIQ3 == ""))?'--SIN ARCHIVO--':'ADJUNTADO', $message);
$message = str_replace('[declaracion]', (($g[0]->ARCHIVO_DECLARA === NULL) || ($g[0]->ARCHIVO_DECLARA == ""))?'--SIN ARCHIVO--':'ADJUNTADO', $message);

$message = str_replace('[cernotas]', (($g[0]->ARCHIVO_CONC_NOTAS === NULL) || ($g[0]->ARCHIVO_CONC_NOTAS == ""))?'--SIN ARCHIVO--':'ADJUNTADO', $message);
$message = str_replace('[cernacim]', (($g[0]->ARCHIVO_CERT_NAC === NULL) || ($g[0]->ARCHIVO_CERT_NAC == ""))?'--SIN ARCHIVO--':'ADJUNTADO', $message);
$message = str_replace('[cermatri]', (($g[0]->ARCHIVO_CERT_MATRI === NULL) || ($g[0]->ARCHIVO_CERT_MATRI == ""))?'--SIN ARCHIVO--':'ADJUNTADO', $message);
$message = str_replace('[jurada]', (($g[0]->ARCHIVO_DECLARA === NULL) || ($g[0]->ARCHIVO_DECLARA == ""))?'--SIN ARCHIVO--':'ADJUNTADO', $message);
$message = str_replace('[segcomp]', (($g[0]->ARCHIVO_SEGUROCOMP === NULL) || ($g[0]->ARCHIVO_SEGUROCOMP == ""))?'--SIN ARCHIVO--':'ADJUNTADO', $message);
...
$email->Subject   = 'Confirmacion de Postulacion #'.'22015'.$g[0]->RUT_TRABAJADOR;
$email->Body      = $message;
...
if(!$email->send()) {
    ...
    echo '|Mensaje Enviado|#22015'.$g[0]->RUT_TRABAJADOR;
}
/*
