...
if($o == "contratoempresa"){
	$query = "SELECT ARCHIVO_CONTRATO as data FROM VIVIENDA_M WHERE IDVIVIENDA = ".revisaSQL($v, "text");
}else if($o == "liquidaciones1"){
	$query = "SELECT ARCHIVO_LIQ1 as data FROM VIVIENDA_M WHERE IDVIVIENDA = ".revisaSQL($v, "text");
}else if($o == "liquidaciones2"){
	$query = "SELECT ARCHIVO_LIQ2 as data FROM VIVIENDA_M WHERE IDVIVIENDA = ".revisaSQL($v, "text");
}else if($o == "liquidaciones3"){
	$query = "SELECT ARCHIVO_LIQ3 as data FROM VIVIENDA_M WHERE IDVIVIENDA = ".revisaSQL($v, "text");
}else if($o == "promesa"){
	$query = "SELECT ARCHIVO_PROMESA as data FROM VIVIENDA_M WHERE IDVIVIENDA = ".revisaSQL($v, "text");
}else if($o == "propiedad"){
	$query = "SELECT ARCHIVO_PROPIEDAD as data FROM VIVIENDA_M WHERE IDVIVIENDA = ".revisaSQL($v, "text");
}else if($o == "deuda"){
	$query = "SELECT ARCHIVO_DEUDA as data FROM VIVIENDA_M WHERE IDVIVIENDA = ".revisaSQL($v, "text");
}else if($o == "declaracion"){
	$query = "SELECT ARCHIVO_DECLARACION as data FROM VIVIENDA_M WHERE IDVIVIENDA = ".revisaSQL($v, "text");
}else die("-1");
