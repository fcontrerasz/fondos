...
$query = sprintf("CALL itiss_POSTULACIONES_WEB_upd (%s, 1, 2, %s, %s, %s, NULL, %s, %s, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, %s, %s, %s, @result);", revisaSQL($i, "int"), revisaSQL($rutempresa, "int"), revisaSQL($dvempresa, "int"),revisaSQL($razon, "text"),revisaSQL($fechatermino, "text"),revisaSQL($division, "text"), revisaSQL($tipoempresa, "text"),revisaSQL($correoempresa, "text"),revisaSQL($prefijoempresa."-".$fonoempresa, "text"));
