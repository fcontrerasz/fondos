...
$query = sprintf("CALL `itiss_POSTULACIONES_WEB_upd` (NULL, 1, %s, NULL, NULL, NULL, NULL, NULL, NULL, %s, %s, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, %s, NULL, %s, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, @result);",revisaSQL($b,"int"), revisaSQL($r, "text"),revisaSQL($dv, "text"),revisaSQL($m, "text"),revisaSQL("09-".$f, "text"));
...
if($ultimo>0){
	if($b == "1"){
		$query = sprintf("CALL itiss_VIVIENDA_upd (NULL, NULL,%s,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,@result);",revisaSQL($ultimo, "int"));
	}else if($b == "2"){
