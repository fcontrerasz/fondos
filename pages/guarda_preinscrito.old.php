...
if($ultimo>0){
	if($b == "1"){
		...
		$query = sprintf("CALL itiss_EDUCACION_upd (NULL, NULL,%s,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,@result);",revisaSQL($ultimo, "int"));
	}
	//echo $query;
	$result = $db->query($query);
	$db->next_result();
